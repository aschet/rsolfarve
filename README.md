...
[![crates.io](https://img.shields.io/crates/v/olfarve.svg)](https://crates.io/crates/olfarve)
[![docs.rs](https://img.shields.io/docsrs/olfarve)](https://docs.rs/olfarve)
...
```rust
use olfarve::{srm_to_srgb, ebc_to_srgb, absorption_to_srgb, DEFAULT_PATH_LENGTH_CM};
...
The path length is always explicit; pass `DEFAULT_PATH_LENGTH_CM` for the
typical case.
